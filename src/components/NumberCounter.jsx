...
const NumberCounter = () => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.3, delay: 0.2 }} // Duration of the animation
      className="absolute ml-36 -mt-28 sm:text-[350px] text-9xl font-bold text-center overflow-hidden text-[#d3aa85] absolute sm:ml-[900px] sm:mt-[450px] mt-0"
    >
